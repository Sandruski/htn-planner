...
{
    static const std::unordered_map<std::string, HTNTokenType> KeywordsToTokenTypes = {
...
bool HTNLexerBase::Lex(std::vector<HTNToken>& outTokens)
{
    bool Result = true;
...
void HTNLexerBase::LexKeywordOrIdentifier(std::vector<HTNToken>& outTokens)
{
