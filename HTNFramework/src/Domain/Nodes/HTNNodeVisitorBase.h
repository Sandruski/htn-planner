...
public:
    ...
    // Visits the given identifier expression node with the given node visitor context
    ...
    // Visits the given literal expression node with the given node visitor context
    ...
    // Visits the given variable expression node with the given value and node visitor context
    ...
    // Visits the given variable expression node with the given node visitor context
    ...
    // Visits the given constant expression node with the given node visitor context
...
protected:
    // Calls the 'Accept' member method on the given node with the given value and node visitor context
    ...
    // Calls the 'Accept' member method on the given node with the given node visitor context
